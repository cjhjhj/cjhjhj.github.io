...
두번째, $w\_{j\_1k\_1}$와 $h2\_{in\_1}$과의 관계는 간단하게 다음과 같이 표현된다.
...
Weight $w\_{j\_\cdot k\_1}$는 $h2\_{in\_1}$에만 기여를 하고, $w_{j_\cdot k_2}$와 $w_{j_\cdot k_3}$도 마찬가지이므로, matrix operation으로 표현하면  
$$\begin{bmatrix} 
